...
CREATE TABLE pcs (
  ...
  audio_output       ENUM('Working', 'Disabled', 'Faulty', 'None') NULL COMMENT 'speaker/audio output health, reported by the PC agent app',
  microphone         ENUM('Working', 'Disabled', 'Faulty', 'None') NULL COMMENT 'microphone health, reported by the PC agent app',
  camera             ENUM('Working', 'Disabled', 'Faulty', 'None') NULL COMMENT 'camera/webcam health, reported by the PC agent app',
  comments           TEXT NULL,
